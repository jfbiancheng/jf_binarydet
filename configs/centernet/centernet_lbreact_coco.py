...
model = dict(
    ...
    neck=dict(
        type='CTResNetNeck',
        in_channel=1024,
        num_deconv_filters=(512,256, 128, 64),
...
work_dir = 'work_dirs/centernet_react_fpn_1x_coco'
load_from  = '/workspace/S/jiangfei/BinaryNeuralNetwork_debug/work_dirs/detect/reactnet_onestep/epoch_75.pth'
seed = 303